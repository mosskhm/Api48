...
namespace Api.CommonFuncations
{
    public class iDoBetMoov
    {
        ...
        {
            bool result = false;
            string token_id = Cache.iDoBet.GetiMoovDoBetUserTokenNew(0, ref lines);
            response_body = "";
            postBody = "";
        ...
        {
            bool result = false;
            string token_id = Api.Cache.iDoBet.GetiMoovDoBetUserTokenNew(0, ref lines);
            ...
            if (!String.IsNullOrEmpty(token_id))
            {
                ...
                headers.Add(new Headers { key = "ExtraData", value = "" });
                headers.Add(new Headers { key = "Token", value = token_id });
                headers.Add(new Headers { key = "Terminal", value = Api.Cache.ServerSettings.GetServerSettings("iDoBetMoovTerminalSecurityCode", ref lines) });
                ...
                if (!String.IsNullOrEmpty(response_body))
                {
                    ...
                    try
                    {
                        if (json_response.data.ToString() != "[]")
                        {
                            ...
                            //"CreditLimit":null,"AvailableCredit":1635.0,"IdentityCard":null,"IPin":1340,"IsValid":true,"IsLocked":false,"IsFullRegistrationDetails":true,"CurrencyCode":"CFA","AvailableForWithdraw":0.0,"PendingWithdraws":null,"Commission":0.0}],"dataStructure":null,"additionalData":null,"userInfo":null}
        ...
        public static List<Tickets> CheckTicketsNew(string MSISDN, ref List<LogLines> lines)
        {
            ...
            //string password = Cache.ServerSettings.GetServerSettings("iDoBetCheckTicketLoginPassword", ref lines);
            //string token_id = GetToken(username, password, ref lines);
            string token_id = Cache.iDoBet.GetMooviDoBetUserTokenCheckTicket(0, ref lines);
            if (!string.IsNullOrEmpty(token_id))
            {
                string idobet_endpoint = Cache.ServerSettings.GetServerSettings("iDoBetEndPointUrl", ref lines);
                lines = Add2Log(lines, " idobet_endpoint = " + idobet_endpoint, 100, "ivr_subscribe");
        ...
        public static bool PlaceBet(USSDSession ussd_session, ref List<LogLines> lines)
        {
            ...
            if (saved_games != null)
            {
                ...
                string token_id = Cache.iDoBet.GetiMoovDoBetUserTokenNew(0, ref lines);
                string terminal_security_token = Cache.ServerSettings.GetServerSettings("iDoBetMoovTerminalSecurityCode", ref lines);
                    ...
                    if (token != null)
                    {
                        ...
                        if (sub_agents != null)
                        {
                            ...
                            if (filtered_sub_agent != null)
                            {
                                ...
                                if (pos_trans_id > 0)
                                {
                                    menu = "Veuillez approuver la transaction Moov Money";
                                }
                                else
                                {
                                    menu = "Error 55";
        ...
        public static string GetDepositMoneyMenu(IdoBetUser user, USSDMenu ussd_menu, string MSISDN, ref List<LogLines> lines)
        {
            ...
            if (user.isValid == false)
            {
                ...
                {
                    menu = "Rejoigner GreenWin pour gagner d'intéressants bonus!" + Environment.NewLine;
                    menu = menu + @"Visiter notre site http://m.greenwin.bj" + Environment.NewLine + Environment.NewLine;
                    menu = menu + "M) Menu Principal ";
                }
                else
                {
        ...
        public static string GetCloseBet(USSDSession ussd_session, string amount, ref List<LogLines> lines)
        {
            ...
            if (saved_games != null)
            {
                ...
                menu = menu + "Pour compléter votre pari, confirmez le paiement." + Environment.NewLine;
                menu = menu + "Confirmez T&C et +18 http://m.greenwin.bj/terms" + Environment.NewLine;
            }
            return menu;
        }
        ...
        public static string GetTokenNew(ref List<LogLines> lines)
        {
            string token_id = "";
            string idobet_endpoint = Cache.ServerSettings.GetServerSettings("iDoBetEndPointUrl", ref lines);
            string iDoBetUserName = Cache.ServerSettings.GetServerSettings("iDoBetMoovLoginUserName", ref lines);
            string iDoBetPassword = Cache.ServerSettings.GetServerSettings("iDoBetMoovLoginPassword", ref lines);
            lines = Add2Log(lines, " idobet_endpoint = " + idobet_endpoint, 100, "ivr_subscribe");
        ...
        public static string GetTokenCheckTicketNew(ref List<LogLines> lines)
        {
            string token_id = "";
            string idobet_endpoint = Cache.ServerSettings.GetServerSettings("iDoBetEndPointUrl", ref lines);
            string iDoBetUserName = Cache.ServerSettings.GetServerSettings("iDoBetMoovCheckTicketLoginUserName", ref lines);
            string iDoBetPassword = Cache.ServerSettings.GetServerSettings("iDoBetMoovCheckTicketLoginPassword", ref lines);
            lines = Add2Log(lines, " idobet_endpoint = " + idobet_endpoint, 100, "ivr_subscribe");
