...
{
    /// <summary>
    /// Summary description for ussd_cameroon
    /// </summary>
    public class ussd_cameroon : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            lines = Add2Log(lines, "*****************************", 100, "ussd_madapicameroon");
            lines = Add2Log(lines, "Incomming XML = " + xml, 100, "ussd_madapicameroon");
            lines = Add2Log(lines, "IP = " + context.Request.ServerVariables["REMOTE_ADDR"], 100, "ussd_madapicameroon");
            lines = Add2Log(lines, "UA = " + context.Request.ServerVariables["HTTP_USER_AGENT"], 100, "ussd_madapicameroon");
            lines = Add2Log(lines, "REFERER = " + context.Request.ServerVariables["HTTP_REFERER"], 100, "ussd_madapicameroon");
            ...
            bool is_close = false;
            ServiceClass service = GetServiceByServiceID(720, ref lines);
            ...
            if (!String.IsNullOrEmpty(xml))
            {
                ...
                string spID = "2370110013381", ServiceID = "", serviceCode = "21", linkid = "", receiveCB = "FFFFFFFF", senderCB = "186597739";
                ...
                if (service != null && ussdString != "")
                {
                    if (umc != null)
                    {
                        ...
                        if (ussd_menu != null)
                        {
                            ...
                            ussd_soap = Api.CommonFuncations.USSD.MTNCameroonUSSDBehaviuer(service, ussdString, ServiceID, MSISDN, linkid, receiveCB, senderCB, serviceCode, ussd_menu, ussd_session, out momo_request, ref lines, out menu_2_display, out is_close, "");
            ...
            if (!String.IsNullOrEmpty(menu_2_display))
            {
                ...
                response_soap = response_soap + "    \"serviceCode\": \"153\",";
