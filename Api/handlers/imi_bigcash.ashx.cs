...
{
    /// <summary>
    /// Summary description for imi_bigcash
    /// </summary>
    public class imi_bigcash : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            lines = Add2Log(lines, "*****************************", 100, "imi_bigcash");
            lines = Add2Log(lines, "IP = " + context.Request.ServerVariables["REMOTE_ADDR"], 100, "imi_bigcash");
            lines = Add2Log(lines, "UA = " + context.Request.ServerVariables["HTTP_USER_AGENT"], 100, "imi_bigcash");
            lines = Add2Log(lines, "REFERER = " + context.Request.ServerVariables["HTTP_REFERER"], 100, "imi_bigcash");
            string redirect_url = "";
            string secret_key = "dcJ3rVLI6B";
            ...
            {
                //check user
                ServiceClass service = GetServiceByServiceID(4, ref lines);
                ...
                redirect_url = "https://mtn.big-cash.co.za/Redirect?cli=" + CommonFuncations.Base64.EncodeDecodeBase64(m, 1);
            ...
            else
            {
                ...
                redirect_url = "http://mtnplay.co.za/portal/jqm.aspx?typxm=subscribecheckBigCash";
            }
