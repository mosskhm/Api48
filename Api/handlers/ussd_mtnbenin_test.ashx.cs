...
{
    /// <summary>
    /// Summary description for ussd_mtnbenin_test
    /// </summary>
    public class ussd_mtnbenin_test : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            lines = Add2Log(lines, "*****************************", 100, "ussd_mtnbenin_test");
            lines = Add2Log(lines, "Incomming XML = " + xml, 100, "ussd_mtnbenin_test");
            lines = Add2Log(lines, "IP = " + context.Request.ServerVariables["REMOTE_ADDR"], 100, "ussd_mtnbenin_test");
            lines = Add2Log(lines, "UA = " + context.Request.ServerVariables["HTTP_USER_AGENT"], 100, "ussd_mtnbenin_test");
            lines = Add2Log(lines, "REFERER = " + context.Request.ServerVariables["HTTP_REFERER"], 100, "ussd_mtnbenin_test");
            ...
            if (!String.IsNullOrEmpty(xml))
            {
                ...
                service = GetServiceByServiceID(698, ref lines);
