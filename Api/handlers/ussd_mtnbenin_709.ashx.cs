...
{
    /// <summary>
    /// Summary description for ussd_mtnbenin_709
    /// </summary>
    public class ussd_mtnbenin_709 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            lines = Add2Log(lines, "*****************************", Convert.ToInt32(ConfigurationManager.AppSettings["log_level"]), "ussd_mtnbenin709");
