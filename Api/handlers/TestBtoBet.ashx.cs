...
{
    /// <summary>
    /// Summary description for TestBtoBet
    /// </summary>
    public class TestBtoBet : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            lines = Add2Log(lines, "*****************************", 100, "test_BtoBet");
            lines = Add2Log(lines, "IP = " + context.Request.ServerVariables["REMOTE_ADDR"], 100, "test_BtoBet");
            lines = Add2Log(lines, "UA = " + context.Request.ServerVariables["HTTP_USER_AGENT"], 100, "test_BtoBet");
            lines = Add2Log(lines, "REFERER = " + context.Request.ServerVariables["HTTP_REFERER"], 100, "test_BtoBet");
            foreach (String key in context.Request.QueryString.AllKeys)
            {
                lines = Add2Log(lines, "Key: " + key + " Value: " + context.Request.QueryString[key], 100, "test_BtoBet");
            }
            ...
            if (umc != null && !String.IsNullOrEmpty(msisdn) && !String.IsNullOrEmpty(user_input))
            {
                ...
                CommonFuncations.iDoBet.USSDSession ussd_session = DataLayer.DBQueries.GetLastUSSDSession(msisdn, umc.ussd_id, ref lines);
                ...
                if (ussd_menu != null)
                {
                    ...
                    ussd_soap = Api.CommonFuncations.USSDBtoBet.MoovUSSDBehaviuer(service, user_input, ServiceID, msisdn, linkid, receiveCB, senderCB, serviceCode, ussd_menu, ussd_session, out momo_request, ref lines, out menu_2_display, out is_close, "");
            ...
            else
            {
                ...
                xml = xml + "			<option choice=\"2\">Depot en ligne</option>";
                xml = xml + "			<option choice=\"3\">Retrait en Ligne</option>";
