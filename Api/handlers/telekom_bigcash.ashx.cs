...
namespace Api.handlers
{
    ...
    /// </summary>
    public class telekom_bigcash : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            lines = Add2Log(lines, "IP = " + context.Request.ServerVariables["REMOTE_ADDR"], 100, "telekom_bigcash");
            lines = Add2Log(lines, "UA = " + context.Request.ServerVariables["HTTP_USER_AGENT"], 100, "telekom_bigcash");
            lines = Add2Log(lines, "REFERER = " + context.Request.ServerVariables["HTTP_REFERER"], 100, "telekom_bigcash");
            ...
            // string redirect_url = "http://optin.telkomsdp.co.za/service/31?ext_ref=123456776";
            string redirect_url = "https://sdp-p-vas-payment.telkom.co.za/31?ext_ref=123456776";
            if (!string.IsNullOrEmpty(context.Request.QueryString["msisdn"]) && !string.IsNullOrEmpty(context.Request.QueryString["result"]) && !string.IsNullOrEmpty(context.Request.QueryString["subscription_id"]))
            {
				...
				//redirect_url = "https://www.telkom.bigcash.co.za/Redirect?cli=" + msisdn + "&sid=714";
                redirect_url = "https://bigcash-telkom.vercel.app/Redirect?cli=" + msisdn + "&sid=714";
            ...
            if (context.Request.Cookies["cli"] != null)
            {
                if (!String.IsNullOrEmpty(context.Request.Cookies["cli"].Value))
                {
                    ...
                    //redirect_url = "https://www.telkom.bigcash.co.za/Redirect?cli=" + context.Request.Cookies["cli"].Value + "&sid=714";
                    redirect_url = "https://bigcash-telkom.vercel.app/Redirect?cli=" + context.Request.Cookies["cli"].Value + "&sid=714";
