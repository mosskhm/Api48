...
{
    /// <summary>
    /// Summary description for telekom_bigcash_ussd1
    /// </summary>
    public class telekom_bigcash_ussd1 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            lines = Add2Log(lines, "*****************************", 100, "telekom_bigcash_ussd");
            ...
            string redirect_url = "https://sdp-p-vas-payment.telkom.co.za/359?ext_ref=123456776";
            if (!string.IsNullOrEmpty(context.Request.QueryString["msisdn"]) && !string.IsNullOrEmpty(context.Request.QueryString["result"]) && !string.IsNullOrEmpty(context.Request.QueryString["subscription_id"]))
            {
                ...
                //redirect_url = "https://www.telkom.bigcash.co.za/Redirect?cli=" + msisdn + "&sid=723";
                redirect_url = "https://bigcash-telkom.vercel.app/Redirect?cli=" + msisdn + "&sid=723";
            ...
            if (context.Request.Cookies["cli"] != null)
            {
                if (!String.IsNullOrEmpty(context.Request.Cookies["cli"].Value))
                {
                    ...
                    //redirect_url = "https://www.telkom.bigcash.co.za/Redirect?cli=" + context.Request.Cookies["cli"].Value + "&sid=723";
                    redirect_url = "https://bigcash-telkom.vercel.app/Redirect?cli=" + context.Request.Cookies["cli"].Value + "&sid=723";
