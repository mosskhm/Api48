...
namespace Api.AirTelCG
{
    ...
    /// </summary>
    public class ussd : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            lines = Add2Log(lines, "*****************************", 100, "ussd_airtelcongo");
            lines = Add2Log(lines, "Incomming request = " + context.Request.QueryString, 100, "ussd_airtelcongo");
            lines = Add2Log(lines, "IP = " + context.Request.ServerVariables["REMOTE_ADDR"], 100, "ussd_airtelcongo");
            lines = Add2Log(lines, "UA = " + context.Request.ServerVariables["HTTP_USER_AGENT"], 100, "ussd_airtelcongo");
            lines = Add2Log(lines, "REFERER = " + context.Request.ServerVariables["HTTP_REFERER"], 100, "ussd_airtelcongo");
            ...
            ussdString = context.Request.QueryString["user_input"];
            ...
            bool is_close = false;
            ServiceClass service = GetServiceByServiceID(1101, ref lines);
            ...
            if (!String.IsNullOrEmpty(menu_2_display))
            {
                ...
                response_soap = menu_2_display;
                
            }
            else
            {
                response_soap = "Welcome to YellowBet";
            }


            lines = Add2Log(lines, "Response = " + response_soap, 100, "ussd_mo");
            context.Response.ContentType = "text/plain";
            context.Response.Headers.Add("Freeflow", freeflowState);
            context.Response.Headers.Add("charge", "N");
