        ...
        public static USSDMenu GetUSSDMenu(int ussd_id, string ussd_string, int action_id, USSDSession ussd_session, ref List<LogLines> lines)
        {
            ...
            if (result_list != null)
            {
                if (result_list.Count() > 0)
                {
                    ...
                    if (((action_id >= 19 && action_id <= 21) || (action_id>= 33 && action_id <= 34) || (action_id >= 72 && action_id <= 74)  || (action_id == 55) || (action_id == 89) || (action_id>=84 && action_id <=85)) && ussd_string != "*" && ussd_string != "8" && ussd_string.ToLower() != "m")
                    {
